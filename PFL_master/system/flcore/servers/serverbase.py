...
class Server(object):
    def __init__(self, args, times):
        ...
        comment = (" " + self.dataset + " " + self.algorithm + '_' +str(self.local_epochs) + '_' +str(self.learning_rate)
                   + '_' + str(self.num_clients) + '_' + str(self.join_ratio) + "_" + str(args.seed)) + "_" + str(args.rank)
    ...
    def select_clients(self):
        if self.random_join_ratio:
            self.current_num_join_clients = np.random.choice(range(self.num_join_clients, self.num_clients+1), 1,
                                                             replace=False)[0]
        else:
            self.current_num_join_clients = self.num_join_clients
    ...
    def save_global_model(self):
        ...
        model_path = os.path.join(model_path, self.algorithm + "_server" + "_" + str(self.seed) + "_" + str(self.learning_rate) + ".pt")
    ...
    def save_results(self):
        ...
        algo = self.dataset + "_" + self.algorithm + '_' +str(self.local_epochs) + '_' +str(self.learning_rate) + '_' + str(self.num_clients)
        result_path = "../results/"
    ...
    def print_(self, test_acc, test_ece, train_loss):
